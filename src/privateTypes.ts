...
import type {
	ArrayAncestor as ArrayAncestor,
	ArrayValidationState,
	AsyncValidator,
	BaseValidationReturn,
	BaseValidationState,
	PrimitiveValidationState,
	SyncValidator,
	ValidatorParams,
} from "./publicTypes.ts";
...
export type PropertyValidationConfig = {
	 ...
	 */
	arrayAncestors: GenericArrayAncestor[];
};

export type GenericArrayAncestor = Partial<ArrayAncestor<unknown, unknown[]>>;
...
export type AnyGenericValidationType =
	| GenericPrimitiveValidation
...
export type GenericSyncValidator = SyncValidator<
	unknown,
	unknown,
	unknown,
	unknown,
...
export type GenericAsyncValidator = AsyncValidator<
	unknown,
	unknown,
	unknown,
	unknown,
...
export type GenericValidationState =
	& Partial<GenericArrayValidationState>
	& GenericPrimitiveValidationState
	& IndexableGenericValidation;
...
export type GenericArrayValidationState = ArrayValidationState<
	unknown,
	unknown
>;
...
export type GenericValidatorParams = ValidatorParams<
	unknown,
	unknown,
	unknown,
	unknown
