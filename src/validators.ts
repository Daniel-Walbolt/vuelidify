import type { Primitive, SyncValidator, ValidatorParams } from './publicTypes.ts';
 ...
 */
export function required<T extends Primitive, P, V = undefined, R = undefined, A = undefined>(): SyncValidator<T, P, V, R, A> {
